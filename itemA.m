...
while iter == true
    ...
    for j = 1:(10/dy)
        for i = 2:(22/dx)
            ...
            if(((i*dx > 14 && i*dx < 16) || (i*dx > 20 && i*dx < 22)) && (j*dy < 6))
                if(j == 1)
            ...
            elseif(i*dx == 5 && j*dy >= 6)
                ...
                if(j == 6/deltax)
                    Az(j, i) = (1/(2*((mi_ferro/mi_ar) + 1))) * ((mi_ferro/mi_ar)*(Az(j-1, i) + Az(j, i-1)) + Az(j+1, i) + Az(j, i+1));
                else 
            ...
            elseif((i*dx == 14 && j*dy < 6))
                ...
                if (j == 1)
                    Az(j, i) = (1/(2*((mi_b/mi_ar) + 1))) * ((mi_b/mi_ar)*(Az(j-1, i) + Az(j, i-1)) + Az(j+1, i) + Az(j, i+1));
                else 
            ...
            elseif((i*dx == 16 && j*dy < 6))
                ...
                if (j == 1)
                    Az(j, i) = (1/(2*((mi_ferro/mi_b) + 1))) * ((mi_ferro/mi_b)*(Az(j-1, i) + Az(j, i-1)) + Az(j+1, i) + Az(j, i+1));
                else 
            ...
            elseif((i*dx == 20 && j*dy < 6))
                ...
                % Caso seja um ponto interno do domínio sem ser fronteira ou bobina (a maioria dos pontos)
            else
                if(j == 1)
