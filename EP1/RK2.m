function [estados, f_hist] = RK2(estados, h, t, m_tot, m_1, L, F, F_1, I, omega)
%RK2: Resolve uma EDO genérica através do método de Runge-Kutta de
%     segunda ordem segundo o critério conhecido como Euler Modificado.
%Input:
